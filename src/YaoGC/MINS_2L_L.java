...
public class MINS_2L_L extends CompositeCircuit {
	private final int L;

	public final static int GT = 0;
	public final static int MUX = 1;

	public MINS_2L_L(int l) {
		super(2 * l, l, 2, "MINS_" + 2 * l + "_" + l);
		L = l;
	}
	...
	protected void connectWires() throws Exception {
		for (int i = 0; i < L; i++) {
			...
			inputWires[i].connectTo(subCircuits[MUX].inputWires,
					MUX_2Lplus1_L.X(i));
			inputWires[i + L].connectTo(subCircuits[MUX].inputWires, MUX_2Lplus1_L
					.Y(i));
		}
